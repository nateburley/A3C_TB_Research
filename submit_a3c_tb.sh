...
#PBS -l walltime=72:00:00                       ## Run time (day:hh:mm:ss), usually 3+ days (currently 2 hrs. for a test)
#PBS -l mem=16gb                           	## Memory requirements, 16G should be good, 32G to be safe
...
#PBS -t 1-5 					## number of trials to run; here submit 3 trials together, usually want 5+ trials to get the average
