...
#PBS -e /data/datascience/UGproject/logs/       ## error file directory; this is where you can see the output logs
#PBS -o /data/datascience/UGproject/logs/       ## output file directory
